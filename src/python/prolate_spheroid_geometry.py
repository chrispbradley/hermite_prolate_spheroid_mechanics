...
class ProlateSpheroid(object):
    ...
    def _calculateElements(self):
        ...
        for k in range(self.numElements[2]):
            # Loop from apex to base
            for j in range(self.numElements[1]):
                # Loop circumferentially
                for i in range(self.numElements[0]):
    ...
    def _calculateNodes(self):
        ...
        # Loop from endocardium to epicardium
        for k in range(self.numElements[2] * elFactor + 1):
            ...
            # Loop from apex to base
            for j in range(self.numElements[1] * elFactor + 1):
                # Loop circumferentially
                for i in range(self.numElements[0] * elFactor):
